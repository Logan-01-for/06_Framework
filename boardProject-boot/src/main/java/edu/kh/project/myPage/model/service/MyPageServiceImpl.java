...
public class MyPageServiceImpl implements MyPageService{
	...
	private String profileWebPath; // my.profile/
	
	@Value("${my.profile.folder-path}")
	private String profileFolderPath; // C:/upleadFiles/profile/
	...
	public int changePw(Map<String, String> paramMap, int memberNo) {
		...
		// DB에 업데이트
		// SQL 전달 해야하는 데이터 2개 (암호화한 새비번 encPw, 회원번호 memberNo)
	...
	public int fileUpload2(MultipartFile uploadFile, int memberNo) throws Exception {
		...
		// bulder 패턴을 이용해서 UploadFile 객체 생성
