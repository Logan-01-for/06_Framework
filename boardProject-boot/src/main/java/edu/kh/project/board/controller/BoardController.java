...
public class BoardController {
	 ...
	 * 
	 * /borad/1, /borad/2, /borad/3
	 * 
	 * /board/xxx 
	 * -> /board 이하 1레벨 자리에 어떤 주소 값이 들어오든 모두 이 메서드 매핑
	 * 
	 * [0-9] : 한칸에 0~9 사이 숫자 하나만 입력 가능
	 * [0-9]+ : 모든 숫자
	 * 
	 *  /board 이하 1레벨 자리에 숫자로된 요청 주소가 작성되어 있을땜나 해당 메서드 매핑
	 *  -> 정규식 이용했기 때문에
	 *  
	 * @return
	 */
	...
	public String selectBoardList(@PathVariable("boardCode") int boardCode, 
		...
		// 조건에 따라 서비스 메서드를 분기 처리하기 위해 map은 선언만 함.
	 ...
	 * 					왜? @PathVariable 어노테이션 이용 시 변수 값이 request scope에 저장되기 때문에)
	 * @param model : 값 전달용 객체
	 * @param loginMember : 로그인 여부와 관련 없이 상세 조회 할수 있어야 함으로 required = false로함
	 * @param ra
	 * @return
	 */
