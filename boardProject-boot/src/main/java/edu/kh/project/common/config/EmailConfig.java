...
public class EmailConfig {
	...
	// @Value : properties에 작성된 내용 중 key 사 일치하는 value 값ㅇ르 얻어와 필드에 대입
	...
	public JavaMailSender javaMailSender() {
		...
		return mailSender;
		// 위처럼 각종 석정이 적용된 JavaMailSender 를 Bean 으로 등록하여
		// Spring 애플리케이션 이메일을 보내기 위한 구성을 제공함.
