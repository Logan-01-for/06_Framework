 ...
 * 
 * - 주요 비즈니스 로직과 관련이 없는 부가적인 시증을 추가할 때 유용
 * 
 * ex) 코드 중간 중산에 로그 찍을때, 트랜잭션 처리하고 싶을 때 등
 * 
 * 주요 어노테이션 
...
public class TestAspect {
	...
	public void controllerEnd(JoinPoint jp) {
		...
		String methodName = jp.getSignature().getName(); // ex) mainPage(), login ..메서드명
