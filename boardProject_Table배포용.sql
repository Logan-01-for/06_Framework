...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$emPZ9VDNoWWSd6h7lNJYX.vj1ZCec6xvnd1.s0BS01c9OEOCCuzbm'
WHERE MEMBER_NO = 1;
...
-- 4/24 수행 완료
	...
	TO_CHAR(FILE_UPLOAD_DATE, 'YYYY-MM-DD') 
	FROM "UPLOAD_FILE"
...
VALUES(1, 1998); -- 1번 회원이 1998번 게시글에 좋아요를 누름
...
(
	...
	UNION
	SELECT NEXT_SEQ_IMG_NO(), '경로2', '원본2', '변경2', 1, 1999 FROM DUAL
	UNION
	SELECT NEXT_SEQ_IMG_NO(), '경로3', '원본3', '변경3', 1, 1999 FROM DUAL
);
...
-- 댓글 목록 조회 SQL
-- LEVEL : ORACLE에서 제공하는 계층형 데이터 조회 할때 "레벨"에 있는지 알려주는
-- 가상의 컬럼
